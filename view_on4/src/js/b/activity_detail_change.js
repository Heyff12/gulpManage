...
require(['../require-config2'], function() {
    require(["zepto"], function($) {
        $(function() {
            //model
            var itemController = function(type) {
                this.type = type;
            };

            var RefreshManager = function(lastScrollY, loadMoer) {
            ...
            window.onscroll = function(e) {
                ...
                if (refreshManager.canScroll) {
                    ...
                    if (screenScrollMaxY > elementMaxY &&
                        scrollScrrlY > refreshManager.lastScrollY &&
                        refreshManager.canLoadMoer &&
                        !refreshManager.loading) {
                    ...
                    } else if (screenScrollMaxY > (elementMaxY) &&
                        scrollScrrlY > refreshManager.lastScrollY &&
                        !refreshManager.canLoadMoer &&
                        !refreshManager.loading) {
                        $('.load').hide();
