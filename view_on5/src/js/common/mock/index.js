define(["mock"], function(mock) {　
    ...
    var activities = {
        ...
        "data": {
            ...
            "total_balances": '@natural(7000000, 8000000)', // 总余额
        }
    };
    ...
    var members = {
        ...
        "data|3-5": [{
            ...
            "balance": '@natural(20000, 80000)', // 该消费者当前余额
        }]
    };
    ...
    var get_activity_history = function() {
    ...
    var service_info = {
        ...
        "data": [{
            ...
            "is_qfgroup": '@natural(0,1)' , // 是否是直营渠道商户, 0不是, 1是
        }]
    };
